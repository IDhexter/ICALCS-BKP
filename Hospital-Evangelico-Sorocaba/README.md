# Backup de Permissões - Hospital Evangélico de Sorocaba (HES)

Este diretório contém o script automatizado para backup e retenção das permissões de acesso (ACLs) do servidor de arquivos (`Dados`) do Hospital Evangélico de Sorocaba.
...
## 💾 Arquivo do Script
*   Você pode baixar o arquivo do script diretamente aqui: [bkp-acl-hes.bat](./bkp-acl-hes.bat)

---

## 💻 Código do Script (`bkp-acl-hes.bat`)
```bat
@echo off
